...
namespace bybit.net.api.WebSocketStream
{
    ...
    {
        public BybitPrivateWebsocket(string apiKey, string apiSecret, bool useTestNet = true, int receiveBufferSize = 8192)
        ...
        public BybitPrivateWebsocket(IBybitWebSocketHandler handler, string apiKey, string apiSecret, bool useTestNet = true, int receiveBufferSize = 8192)
